...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="../assets/images/android-chrome-192x192.png"><!-- Favicon / Icon -->
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="../assets/images/android-chrome-192x192.png" class="img-logo" alt="KapeTann Logo">
            </a>
