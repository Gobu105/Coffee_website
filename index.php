...
<html lang="en">
    <head>
        ...
        <img rel="icon" type="image/x-icon" href="assets/images/android-chrome-192x192.png"><!-- Favicon / Icon -->
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="assets/images/android-chrome-192x192.png" class="img-logo" alt="SkillStock Logo">
            </a>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                <div class="image">
                    <img src="assets/images/android-chrome-512x512.png" alt="" class="img-fluid">
                </div>
                <div class="content">
            ...
            <div class="box-container">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m1.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m2.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m3.jpg" alt="" class="product-img">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m4.jpeg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m5.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m6.jpg" alt="" class="product-img">
                    ...
                    <div class="row row-to-hide">
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m7.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m8.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m9.jpg" alt="" class="product-img">
                    ...
                    <div class="row row-to-hide">
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m10.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m11.jpg" alt="" class="product-img">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/m12.jpg" alt="" class="product-img">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <img src="assets/images/i2.png" alt="" class="user">
                                <h3>Jane Doe</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <img src="assets/images/i1.png" alt="" class="user">
                                <h3>John Doe</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    <img src="assets/images/android-chrome-192x192.png" class="img"><br />
